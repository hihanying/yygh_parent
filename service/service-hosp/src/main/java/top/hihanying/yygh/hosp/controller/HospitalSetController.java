...
public class HospitalSetController {
     ...
     * @return 逻辑删除成功或者失败
     */
    @ApiOperation(value ="通过 id 逻辑删除一条记录")
     ...
     * @return 逻辑删除成功或者失败
     */
    @ApiOperation(value ="通过多个 id 逻辑删除多条记录")
     ...
     * @return 修改成功或者失败
     */
    @ApiOperation(value ="修改HospitalSet记录")
     ...
     * @return 所查询的记录
     */
    @ApiOperation(value = "根据 id 查询一条HospitalSet记录")
    ...
    @ApiOperation(value = "查询所有HospitalSet记录")
     ...
     * @return 查询结果
     */
    @ApiOperation(value = "条件查询HospitalSet分页")
     ...
     * @return 返回设置成功
     */
    @ApiOperation(value = "HospitalSet记录的锁定和解锁")
     ...
     * @return Result.ok()
     */
    @ApiOperation(value = "发送HospitalSet签名密匙")
